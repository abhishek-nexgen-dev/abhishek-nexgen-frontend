  ...
  return (
    <section className="w-full flex flex-col overflow-hidden px-[2vw] py-[10vh]">
      <div className="w-full text-center mb-10 md:mb-16">
        <h2 className="text-[1.5rem] lg:text-[1.8vw] font-bold inline-flex items-center justify-center my-[5vh]">
      ...
      <div className="w-full flex flex-col-reverse lg:flex-row relative">
        ...
        {/* Image Section - Right */}
        <div
          className="w-full lg:w-[40%] relative lg:absolute lg:right-0 lg:top-0 lg:bottom-0 
                      flex items-center justify-end   h-[40vh] lg:h-auto"
        >
