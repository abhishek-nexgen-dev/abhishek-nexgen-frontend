  ...
  return (
    <div className="h-screen w-screen text-white flex bg-[#181818]">
      ...
      <div className="About_Project w-full md:w-1/2 h-full py-[1vh] px-[2vw] flex flex-col justify-center">
        {/* Title */}
        <h1
          className="text-[3vw] md:text-[2vw] font-bold mb-6 text-transparent bg-gradient-to-r from-[#FF8660] to-[#D5491D] bg-clip-text"
        >
          Projects Category
        </h1>
        ...
        {/* Features Section */}
        <h2 className="text-[#FF8660] text-[1.2vw] md:text-[1vw] font-bold mb-3 flex items-center">🚀 Features</h2>
